...
const Billing = () => {
  return (
    <section id='prouct' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        Lorem ipsum dolor sit amet. Est tempore consequuntur sit ratione voluptatum 33 cupiditate autem et nesciunt necessitatibus ad sunt blanditiis ut voluptatem inventore? 
        </p>
